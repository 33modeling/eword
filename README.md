...
6세 첫 영어 학습자를 위한 그림 단어 암기/퀴즈 웹앱입니다. 300개 일상 단어를 30단계로 나누어 먼저 그림, 뜻, 짧은 영어 문장으로 외운 뒤 4지선다 퀴즈로 확인합니다.

## 주요 기능

- 단계형 학습: 30단계, 단계별 10개 단어 구성
- 암기 카드: 단어, 한국어 뜻, 영어 예문, 그림 설명을 먼저 확인
- 그림 퀴즈: 그림과 한국어 문제를 보고, 선택지는 영어 단어만 보고 정답 선택
- 선명한 이미지 카드: 300개 단어 전체에 큰 컬러 이모지 기반 학습 이미지 제공
